...
public class MainActivity extends AppCompatActivity {
    ...
    //LA URL INCIAL CON LA QUE FUNCIONA ES "https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&starttime=2012-01-01&endtime=2012-12-01&minmagnitude=6"
        ...
        private String makeHttpRequest(URL url) throws IOException {
            ...
            try {
                ...
                jsonResponse = readFromStream(inputStream);}else{
                    ...
                    String errorConection = String.valueOf(urlConnection.getResponseCode());

                    Log.e(LOG_TAG, "Error while conecting to URL: " + errorConection  );
                }

            } catch (IOException e) {
                // TODO: Handle the exception
                Log.e(LOG_TAG, "Exception thrown type: IOException ", e);
